...
r-3-6 Function references
r-3-6-1 The software must support the use of pre-defined functions referenced via func:<name> syntax in the recipe to execute logic.
r-3-6-2 Functions must support optional keyword arguments, which may reference variables via the var:<name> syntax.
